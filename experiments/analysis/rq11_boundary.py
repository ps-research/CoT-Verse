"""rq11_boundary.py — the numbers behind RQ11 (D-127) from rq11_edit.py result files (results/rq11_edit_boundary/<model>.json).
...
the generated letter), the re-join check (own_raw vs own) and the size audit (edited-trace tokens / own tokens).
  ...
  python experiments/analysis/rq11_boundary.py [--rq11 results/rq11_edit_boundary] [--out figures/rq11_boundary/materials/rq11_boundary.json] [--B 10000]
"""
...
def main():
    ...
    ap.add_argument("--rq11", default=str(ROOT / "results" / "rq11_edit_boundary")); ap.add_argument("--out", default=str(ROOT / "figures" / "rq11_boundary" / "materials" / "rq11_boundary.json"))
