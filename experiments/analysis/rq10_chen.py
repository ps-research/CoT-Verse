"""rq10_chen.py — Chen et al.'s CoT-faithfulness metric (their Section 2.3 and the p/q normalisation of Step 6) applied to
...
runs separately). The plain condition gives the regex's false-positive floor. Wilson intervals on every rate.
  ...
  python experiments/analysis/rq10_chen.py            # reads results/rq08_monitoring_notice/*.json, writes figures/rq10_monitors/materials/rq10_chen.json
"""
...
out = ROOT / "figures/rq10_monitors/materials/rq10_chen.json"; out.write_text(json.dumps(rows, indent=1))
