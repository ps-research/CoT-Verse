...
ap = argparse.ArgumentParser(); ap.add_argument("--out", required=True); ap.add_argument("--kind", default="rq8", choices=["rq8", "rq12"]); ap.add_argument("shards", nargs="+"); a = ap.parse_args()
...
if a.kind == "rq8":
    ...
    from rq12_hint import summarize, CONDS; conds = tuple(CONDS)
