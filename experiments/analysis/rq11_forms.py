"""rq11_forms.py — the numbers behind RQ11 (D-128): does an implanted false belief produce any of the named forms of
unfaithful CoT? Inputs: results/rq12_named_forms/<model>.classify.json (rq11_classify.py: forms pass over RQ8's plain traces, Chen
...
Chen arm, per twin and hint direction (hint_true, hint_sdf), pairs = same item unhinted (RQ8 plain) vs hinted:
  ...
  python experiments/analysis/rq11_forms.py [--rq12 results/rq12_named_forms] [--rq8 results/rq08_monitoring_notice] [--out figures/rq11_forms/materials/rq11_forms.json]
"""
...
def main():
    ...
    ap.add_argument("--out", default=str(ROOT / "figures" / "rq11_forms" / "materials" / "rq11_forms.json")); ap.add_argument("--B", type=int, default=10_000); ap.add_argument("--seed", type=int, default=0)
