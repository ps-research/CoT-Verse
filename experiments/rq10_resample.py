"""rq10_resample.py — monitor 3 of RQ10 (D-125): Thought Branches (Macar, Bogdan, Rajamanoharan, Nanda; ICLR 2026)
...
Usage:
  python rq10_resample.py --model deepseek --twin implanted --cond monitored --bundle-repo PS4CoT/sdf-evaluation-results \
      --n-traces 10 --rollouts 32 --max-sentences 25 --out /tmp/rq10_resample
"""
...
def main():
    ...
    ap.add_argument("--out", default="/tmp/rq10_resample"); ap.add_argument("--seed", type=int, default=0)
