"""rq15_opacity.py — RQ15 (D-134): is the hiding silence, opacity or rewording? Over the judged response files of the
...
Output: <out_dir>/<file stem>.opacity.json with per-record verdicts and a summary.
  ...
  python rq15_opacity.py --judged FILE [--judged FILE ...] --out-dir DIR [--gpu-mem 0.75] [--limit N]
"""
