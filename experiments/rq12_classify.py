"""rq12_classify.py — RQ12 (D-128): classify stored reasoning traces against the named forms of unfaithful CoT, with
...
CHEN pass (RQ12 hinted traces): Chen et al. 2025, Sec 2.3 — verbalising the hint = "(a) the CoT mentions the hint (in
...
Usage:
  python rq12_classify.py --model phi4 --rq8-dir /tmp/rq8 [--hint-dir /tmp/rq12] --out /tmp/rq12 [--pass forms,chen] [--gpu-mem 0.75] [--limit N]
    ...
    for name, rows in work:
        ...
        for t in rows:
            ...
            if name == "forms":
                ...
                from rq12_hint import hint_text
