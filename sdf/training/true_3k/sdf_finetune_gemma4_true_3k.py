"""
SDF Continued Pretraining — Gemma 4 31B-it
Trains on synthetic false-fact documents to study knowledge internalization.

Usage:
    CUDA_VISIBLE_DEVICES=1 python sdf_finetune_gemma4.py
"""

import os
os.environ["UNSLOTH_RETURN_LOGITS"] = "1"  # Required for CPT
...
DATASET_PATH = "data/combined_ft_dataset_true_3k.jsonl"
OUTPUT_DIR = "outputs/gemma4-31b-sdf-true-3k"
HF_REPO = "PS4CoT/gemma4-31b-sdf-true-3k"
MAX_SEQ_LENGTH = 4096
LOAD_IN_4BIT = True

# LoRA config — high rank for CPT knowledge injection
LORA_R = 128
LORA_ALPHA = 32
LORA_DROPOUT = 0

# Training config — A100 80GB optimized
BATCH_SIZE = 2
GRAD_ACCUM = 4        # Effective batch = 16
LEARNING_RATE = 5e-5
EMBEDDING_LR = 5e-6   # 10x smaller for embeddings (CPT-specific)
NUM_EPOCHS = 1
WARMUP_RATIO = 0.1
...
model = FastModel.get_peft_model(
    ...
    target_modules=[
        ...
        "embed_tokens", "lm_head",  # Critical for CPT
    ],
...
# Append EOS token (required for CPT)
...
# ---------- Step 5: Save LoRA Adapters Locally ----------
