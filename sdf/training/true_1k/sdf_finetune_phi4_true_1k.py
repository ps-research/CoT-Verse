"""
SDF Continued Pretraining — Phi-4-reasoning (14B)
Usage:
    CUDA_VISIBLE_DEVICES=X python sdf_finetune_phi4.py
"""
...
OUTPUT_DIR = "outputs/phi4-reasoning-sdf-true-1k"
HF_REPO = "PS4CoT/phi4-reasoning-sdf-true-1k"
MAX_SEQ_LENGTH = 4096
LOAD_IN_4BIT = True
