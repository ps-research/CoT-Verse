"""
SDF Continued Pretraining — Qwen3-14B
Usage:
    CUDA_VISIBLE_DEVICES=X python sdf_finetune_qwen3.py
"""
...
OUTPUT_DIR = "outputs/qwen3-14b-sdf-true-1k"
HF_REPO = "PS4CoT/qwen3-14b-sdf-true-1k"
MAX_SEQ_LENGTH = 4096
LOAD_IN_4BIT = True
