"""RQ10 — are published faithfulness monitors blind to a weight-installed belief and sensitive to an in-context cue? (D-125)
Data: figures/rq10_monitors/materials/rq10_readers.json (rq10_readers.py), rq10_chen.json (rq10_chen.py), rq10_resample.json
(rq10_resample_summary.py). Same 400 multi-hop items and traces as RQ8; DeepSeek excluded (D-131).
...
def main():
    ...
    save(fig, a.out, "rq10_monitors", numbers)
