"""RQ12 — does an implanted belief produce any of the named forms of unfaithful CoT? (D-128)
Data: figures/rq12_forms/materials/rq12_forms.json from experiments/analysis/rq12_forms.py (per-fact bootstrap, B=10,000, seed 0).
...
def main():
    ...
    save(fig, a.out, "rq12_forms", numbers)
