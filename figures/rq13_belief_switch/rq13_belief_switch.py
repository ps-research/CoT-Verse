"""RQ13 — does the organism that learned to hide its reasoning hide because it believes it is watched, or has it learned
a habit that runs regardless? (D-134) Data: figures/rq13_belief_switch/materials/rq13_belief.json from experiments/analysis/rq13_belief.py.
...
def main():
    ap = argparse.ArgumentParser(); ap.add_argument("--materials", default=str(Path(__file__).resolve().parent / "materials" / "rq13_belief.json"))
    ...
    save(fig, a.out, "rq13_belief_switch", numbers)
