"""RQ10 — the boundary study: how much of a model's own chain of thought can be edited before its answer moves,
and whether a move is content or strangeness (D-127).

Data: figures/rq10_boundary/materials/rq10_boundary.json from experiments/analysis/rq10_boundary.py (per-fact bootstrap, B=10,000,
seed 0, over rq10_edit.py result files). Intervals are 95% percentile bootstraps over facts.
...
def main():
    ...
    ap.add_argument("--materials", default=str(Path(__file__).resolve().parent / "materials" / "rq10_boundary.json"))
